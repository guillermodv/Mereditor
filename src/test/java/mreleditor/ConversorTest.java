...
public class ConversorTest {
	...
	public void convertirEntidadesRelacionadasUnoAMuchos() {
		...
		esDuenia.addParticipante(esDuenia.new EntidadRelacion(esDuenia,
				persona, "duenia", "0", "N"));
		esDuenia.addParticipante(esDuenia.new EntidadRelacion(esDuenia, auto,
				"dueniaDe", "1", "1"));
	...
	public void convertirEntidadesRelacionadasMuchosAMuchos() {
		...
		aprobo.addParticipante(aprobo.new EntidadRelacion(aprobo, alumno,
				"quien", "0", "N"));
		aprobo.addParticipante(aprobo.new EntidadRelacion(aprobo, materia,
				"que", "0", "N"));
		Atributo fecha = new Atributo("fecha");
		fecha.setTipo(TipoAtributo.CARACTERIZACION);
		fecha.setCardinalidadMaxima("1");
